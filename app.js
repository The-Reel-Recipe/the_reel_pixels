...
const L = {
  en: {
    ...
    'au.registerNote': 'Your pixels, paint and history stay exactly as they are — this attaches them to your Google account so you can sign in anywhere.',
  ...
  ar: {
    ...
    'au.registerNote': 'بكسلاتك وبويتك وتاريخك بيفضلوا زي ما هما — بس بنربطهم بحساب جوجل بتاعك عشان تدخل من أي حتة.',
